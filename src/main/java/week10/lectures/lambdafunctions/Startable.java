package week10.lectures.lambdafunctions;


import week10.lectures.lambdafunctions.classes.Engine;
import week10.lectures.lambdafunctions.interfaces.Printable;
import week10.lectures.lambdafunctions.interfaces.Readable;
...
class Startable {
    ...
    // Any object that implements a Readable interface can be passed in here
...
class Testable {
    ...
    public static void main(String args[]) {
        ...
        // Creating an object of Test to call operates using different implementations using lambda Expressions
        Testable tobj = new Testable();

        // Add two numbers using a lambda expression
        System.out.println("Addition is " + operate(6, 3, add));

        // Multiply two numbers using a lambda expression
